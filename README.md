...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-10-08 09:29`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/6bfffdb8-28cb-4438-b611-bae6240c655a.git
$ cd 6bfffdb8-28cb-4438-b611-bae6240c655a
```
